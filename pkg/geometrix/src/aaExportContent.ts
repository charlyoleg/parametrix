...
function makeOpenscad(geome0: tGeom, designName: string): string {
	...
	const faceId = 'teethProfile';
	rStr += figFaces[faceId];
	rStr += `
module subpax_${designName}_${faceId} () {
	linear_extrude(height = 200) polygon(a_${designName}_${faceId}, b_${designName}_${faceId});
}
subpax_${designName}_${faceId}();
`;
	return rStr;
}
